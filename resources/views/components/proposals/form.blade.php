<x-ui.modal>
    <form class="flex flex-col gap-6" wire:submit.prevent="save" x-data="{ email: @entangle('email'), hours: @entangle('hours'), agree: @entangle('agree') }">
        <div>
        ...
        <div class="flex gap-4">
            <div class="w-2/3 gap-2 flex flex-col">
                ...
                @error('email')
                    <div class="text-[#FF4D4F] text-[14px]">{{ $message }}</div>
                @enderror
            </div>
            <div class="w-1/3 gap-2 flex flex-col">
                ...
                <div class="flex">
                    <button type="button"
                        ...
                        @click="hours > 0 ? hours-- : 0">
                        -
                    </button>
                    <input type="number" x-model="hours" min="0"
